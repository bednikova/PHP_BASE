...
$MAX_COUNT_USERS = 20;   //200  
//min 100 -> test 3
$maxUser = random_int(3, $MAX_COUNT_USERS);
...
//функция, която създава таблично представяне на масива
function tableArray($users){
    
    echo "===============================================================\n";
    echo "||    ID    |"."|   user name   |"."|   password   |"."|      orders      \n";
    echo "===============================================================\n";
    for($i = 0; $i < count($users); $i++){
        ...
        $ord = $users[$i]['orders'];
         ...
         for($j = 0; $j < (10 - strlen($password)); $j++){
             echo " ";
...
tableArray($newUsersArraySortCash);
...
echo "\n======================================================================\n";
echo "Task3_6 \n";
echo "New array - sort by max count orders \n\n\n";
//създава нов масив, в който записите да са 
//сортирани по брой поръчки 
...
tableArray($newUsersArraySortOrders);
